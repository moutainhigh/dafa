 ...
 * 交易管理 >游戏记录查询 > 捕鱼游戏记录
 */
public class CmsFishGameRecord {
    private static String path = "/v1/game/cmsFishGameRecord";
    private static String cmsBankerGameRecordInfo = "/v1/game/cmsFishGameRecordInfo";
    private static String getFishes = "/v1/game/getFishes";//获取捕鱼列表，下拉框使用
