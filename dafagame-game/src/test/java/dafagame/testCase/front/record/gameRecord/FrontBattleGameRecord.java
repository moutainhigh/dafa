 ...
 * 记录 > 游戏记录 > 对战游戏记录
 * */
public class FrontBattleGameRecord {

    private static String path = "/v1/game/frontBattleGameRecord";
    private static String info = "/v1/game/frontBattleGameRecordInfo";

    @Test(description = "对战游戏记录")
    public static void test01() {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            System.out.println(jsonResult0);
            //AssertUtil.assertCode(jsonResult0.getInt("code")==1,result0);
        }
    }

    /*@pers.utils.daoUtils.UnderlineHump(description = "对战游戏记录详情")
