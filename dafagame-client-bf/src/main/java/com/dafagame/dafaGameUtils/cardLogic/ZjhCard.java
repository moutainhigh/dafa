...
public enum ZjhCard {
    ...
    FANG_KUAI_J(11, 11, CardSuit.FANG_KUAI, 44),
    FANG_KUAI_Q(12, 12, CardSuit.FANG_KUAI, 48),
    FANG_KUAI_K(13, 13, CardSuit.FANG_KUAI, 52),

    /*
     * 梅花 A - K,13-25
     */
    MEI_HUA_A(14, 1, CardSuit.MEI_HUA, 5),
    ...
    MEI_HUA_J(11, 11, CardSuit.MEI_HUA, 45),
    MEI_HUA_Q(12, 12, CardSuit.MEI_HUA, 49),
    MEI_HUA_K(13, 13, CardSuit.MEI_HUA, 53),

    /*
     * 红桃 A - K，26-38
     */
    HONG_TAO_A(14, 1, CardSuit.HONG_TAO, 6),
    ...
    HONG_TAO_J(11, 11, CardSuit.HONG_TAO, 46),
    HONG_TAO_Q(12, 12, CardSuit.HONG_TAO, 50),
    HONG_TAO_K(13, 13, CardSuit.HONG_TAO, 54),

    //黑桃 A - K,39-51
    HEI_TAO_A(14, 1, CardSuit.HEI_TAO, 7),
    ...
    HEI_TAO_J(11, 11, CardSuit.HEI_TAO, 47),
    HEI_TAO_Q(12, 12, CardSuit.HEI_TAO, 51),
    HEI_TAO_K(13, 13, CardSuit.HEI_TAO, 55),
    ...
    private ZjhCard(int power, int num, CardSuit type, int index) {
        this.power = power;
        this.num = num;
        this.type = type;
        this.index = index;
     ...
     */
    public static ZjhCard card(int cardId) {
    ...
    public  static ZjhCard getZjhCard(int index) {
        for (ZjhCard zjhCard : values()) {
            if (index == zjhCard.index)
                return zjhCard;
        }
        return null;
    }
