...
APP_NAME=dafacloud-web-api-0.0.1-SNAPSHOT.jar
project_name=dafacloud-web-api
out=out-dafacloudwebapi.txt
...
start(){
  ...
  if [[ $? -eq 0 ]]; then
    ...
    cd /root/.m2/repository/pers/dafacloud/${project_name}/0.0.1-SNAPSHOT
    rm -rf /usr/duke/${out}
