...
public class Request {
     ...
     */
    public static String getBody(String url, String body, Map<String, String> headers, CloseableHttpClient httpclient) {
    ...
    public static Map<String, Object> doPost(String url, String body, Map<String, String> headers) {
        ...
        String result = getBody(url, body, headers, httpclient);
     ...
     * 主要用在需要依赖登陆的请求
     */
    public static String doPost(String url, String body, Map<String, String> headers, Cookie cookie) {
     ...
     * get返回body
     */
    public static String doGetBody(String url, Map<String, String> headers, CloseableHttpClient httpclient) {
        if (StringUtils.isEmpty(url)) {
            return null;
        }
        // 设置请求超时时间
    ...
    public static String doGet(String url, Map<String, String> headers, Cookie cookie) {
        ...
        cookieStore.addCookie(cookie);
        httpclient = SSLClientCustom.getHttpClinet(cookieStore);
        String body = doGetBody(url, headers, httpclient);
        return body;
    }
