...
@MyTestClass
public class P04AliPay {
    private static final String payName = "支付宝(勿动)";

    private static String alipayList() {
        String path = "/v1/transaction/alipayList";
    ...
    @MyTestCase
    public static void saveOrUpdateAlipay() {
        if (alipayList().contains(payName)) {
            System.out.println("已存在支付方式");
            return;
        }
        String path = "/v1/transaction/saveOrUpdateAlipay";
        String body = UrlBuilder.custom()
                .addBuilder("payAlias", payName)
                .addBuilder("payType", "一般")
                .addBuilder("name", "阿里")
                .addBuilder("account", "alibaba")
                .addBuilder("qrcode")
                ...
                .addBuilder("auditInfo", "支付宝姓名#falg#请填写您的支付宝姓名")
     ...
     */
    @MyTestCase
    public static void updateAlipayPaymentListSort() {
        JSONObject jsonObject = JSONObject.parseObject(alipayList());
        ...
        String body = UrlBuilder.custom()
                ...
                .fullBody();
        String path = "/v1/transaction/updateAlipayPaymentListSort";
