...
@MyTestClass
public class P08UnionPay {
    private static final String payName = "银联(勿动)";

    private static String getList() {
        String path = "/v1/transaction/unionpayList";
    ...
    public static void saveOrUpdate() {
        ...
        String path = "/v1/transaction/saveOrUpdateUnionpay";
        String body = UrlBuilder.custom()
        .addBuilder("payAlias",payName)
        .addBuilder("payType","一般")
        .addBuilder("name","银联账户名")
        .addBuilder("account","银联account")
        .addBuilder("qrcode")
        ...
        .addBuilder("auditInfo","您的姓名#falg#请填写您的姓名")
    ...
    public static void updateSort() {
        ...
        String body = UrlBuilder.custom()
                ...
                .fullBody();
        String path = "/v1/transaction/updateUnionpayPaymentSort";
