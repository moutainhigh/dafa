...
@MyTestClass
public class P06Quickpass {
    private static final String payName = "云闪付(勿动)";

    private static String getList() {
        String path = "/v1/transaction/quickpassList";
    ...
    public static void saveOrUpdate() {
        ...
        String path = "/v1/transaction/saveOrUpdateQuickpass";
        String body = UrlBuilder.custom()
        .addBuilder("payAlias",payName)
        .addBuilder("payType","一般")
        .addBuilder("name","账户名")
        .addBuilder("account","Quickpassaccount")
        .addBuilder("qrcode")
        ...
        .addBuilder("auditInfo","账户姓名#falg#请填写您的账户姓名")
    ...
    public static void updateSort() {
        ...
        String body = UrlBuilder.custom()
                ...
                .fullBody();
        String path = "/v1/transaction/updateQuickpassPaymentListSort";
