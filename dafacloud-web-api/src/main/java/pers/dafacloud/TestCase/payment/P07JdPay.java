...
@MyTestClass
public class P07JdPay {
    private static final String payName = "京东钱包(勿动)";

    private static String getList() {
        String path = "/v1/transaction/jdpayPaymentList";
    ...
    public static void saveOrUpdate() {
        if (getList().contains(payName)) {
            System.out.println("已存在支付方式");
            return;
        }
        String path = "/v1/transaction/saveOrUpdateJdpayPayment";
        String body = UrlBuilder.custom()
        .addBuilder("payAlias",payName)
        .addBuilder("payType","一般")
        .addBuilder("name","jd账户名")
        .addBuilder("account","jd账号")
        .addBuilder("qrcode")
        ...
        .addBuilder("auditInfo","京东户名#falg#请填写您的京东户名")
    ...
    public static void updateSort() {
        JSONObject jsonObject = JSONObject.parseObject(getList());
        ...
        String body = UrlBuilder.custom()
                ...
                .fullBody();
        String path = "/v1/transaction/updateJdpayPaymenttListSort";
