...
public class dafaApiContrller {
    ...
    public void request(String host, String cookie, String apiName, String path, String cmsFront, String owner,
        ...
        apiContent.setDeMethod2(deMethod2);
        apiContent.setDeReturnValue2(deReturnValue2);
        apiContent.setIsLoginReq(path.endsWith("login"));////是否是登录请求
