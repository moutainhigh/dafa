...
public class RoutingDataSouceImpl extends AbstractRoutingDataSource {
    ...
    @Autowired
    @Qualifier("proBetting")
    private DataSource proBetting;
    ...
    public void afterPropertiesSet() {
        ...
        targetDataSources.put(DataSourceType.proBetting, proBetting);
    ...
    protected Object determineCurrentLookupKey() {
        ...
        String typeKey = DataSourceContextHolder.getDataSourceKey();
