...
//			QueryRunner queryRunner = new QueryRunner(true);
			String sql =
			 "INSERT IGNORE INTO bet_success(action,lotId,lotname,termNo,multiple,betCount,betAmount,termCount,betContent,betTypes,TypesName,termNos,Multiples,winStop,stopWinCount,CouponId,Value,userCenter) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
//			try {
