...
public class TenantLotteryTestPK10 {
    ...
    public static void main(String[] args) throws Exception {
        List<String> betContents1k = FileUtil.
                readFile(TenantLotteryTestPK10.class.getResourceAsStream("/svBetContentPk10/1312.txt"));
        List<String> user1fpk10 = new ArrayList<>();
        ...
        for (int i = 0; i < users1.size(); i++) { //用户
            ...
            new Thread(() -> {
                ...
                for (int j = 0; j < 1000000000; j++) {
                    ...
                    if (betContentArray[0].equals("1312") || betContentArray[0].equals("1018")) {
