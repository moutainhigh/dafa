 ...
 * 站长彩种压测
 */
public class ThreadTenantLottery2 {
    ...
    public static void main(String[] args) throws Exception {
        List<String> betContents1k = FileUtil.
                readFile(ThreadTenantLottery2.class.getResourceAsStream("/svBetContent/1418.txt"));
        List<String> betContents5k = FileUtil.
                readFile(ThreadTenantLottery2.class.getResourceAsStream("/svBetContent/1419.txt"));
        List<String> betContents1s = FileUtil.
                readFile(ThreadTenantLottery2.class.getResourceAsStream("/svBetContent/1018.txt"));
        List<String> betContents5s = FileUtil.
                readFile(ThreadTenantLottery2.class.getResourceAsStream("/svBetContent/1019.txt"));
        ...
        user5k.add("50352438,shalv010,shalv010a0001");
        user5k.add("50352432,shalv008,shalv008a0001");
        betting(user5k, betContents5k, 300);

        List<String> user1s = new ArrayList<>();
        user1s.add("50352461,shalv010,shalv010a0002");
        user1s.add("50352454,shalv008,shalv008a0002");
        betting(user1s, betContents1s, 60);

        List<String> user5s = new ArrayList<>();
        user5s.add("50352539,shalv010,shalv010a0003");
        user5s.add("50352499,shalv008,shalv008a0003");
