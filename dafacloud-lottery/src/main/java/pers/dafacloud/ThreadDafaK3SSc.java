...
public class ThreadDafaK3SSc {
    ...
    public static void main(String[] args) throws Exception {
        List<String> betContents1k = FileUtil.
                readFile(ThreadTenantLotteryPre.class.getResourceAsStream("/dafaK3SscBetContent/1407.txt"));
        List<String> betContents5k = FileUtil.
                readFile(ThreadTenantLotteryPre.class.getResourceAsStream("/dafaK3SscBetContent/1412.txt"));
        List<String> betContents1s = FileUtil.
                readFile(ThreadTenantLotteryPre.class.getResourceAsStream("/dafaK3SscBetContent/1008.txt"));
        List<String> betContents5s = FileUtil.
                readFile(ThreadTenantLotteryPre.class.getResourceAsStream("/dafaK3SscBetContent/1009.txt"));
        ...
        user1k.add("dafai0005");
        //user1k.add("dafai0001");
        betting(user1k, betContents1k, 5);

        List<String> user5k = new ArrayList<>();
        user5k.add("dafai0002");
        //user5k.add("dafai0002");
        betting(user5k, betContents5k, 50);

        List<String> user1s = new ArrayList<>();
        user1s.add("dafai0003");
        //user1s.add("dafai0003");
        betting(user1s, betContents1s, 5);

        List<String> user5s = new ArrayList<>();
        user5s.add("dafai0004");
        betting(user5s, betContents5s, 50);
        ...
        for (int i = 0; i < users1.size(); i++) { //用户
            ...
            new Thread(() -> {
                ...
                for (int j = 0; j < 1000000000; j++) {
                    ...
                    if (betContentArray[0].equals("1008") || betContentArray[0].equals("1407")) {
