...
public enum BetLotteryEu {
    ...
    BetLotteryEu(String name, String code, String type, boolean isTenant, int timeType) {
        this.name = name;
        this.code = code;
        this.type = type;
    ...
    public static BetLotteryEu getLottery(String lotteryCode) {
        for (BetLotteryEu lotteryConfig : values()) {
