 ...
 * 站长彩种压测
 */
public class TenantLotteryYfWfLHC {
    ...
    public static void main(String[] args) throws Exception {
        List<String> betContents1flhc = FileUtil.
                readFile(TenantLotteryYfWfLHC.class.getResourceAsStream("/betContent/1300yflhc.txt"));
        List<String> betContents5flhc = FileUtil.
                readFile(TenantLotteryYfWfLHC.class.getResourceAsStream("/betContent/1305wflhc.txt"));
