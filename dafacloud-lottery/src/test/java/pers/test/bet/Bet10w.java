package pers.test.bet;

import net.sf.json.JSONArray;
import net.sf.json.JSONObject;
import org.apache.http.Header;
import org.testng.annotations.Test;
import pers.dafacloud.betRun.LotteryIssuePrivate;
...
public class Bet10w {
    ...
    private static void run() {
        //List<String> users = FileUtil.readFile("/Users/duke/Documents/dafaUsers/dev2DafaYuebaoRebate.txt");
        List<String> users = FileUtil.readFile("./dafaUsers/dev2DafaYuebaoRebateSSC.txt");
    ...
    private static String getChaseBetting(String rebate) {
        ...
        JsonArrayBuilder jsonArrayBuilder = JsonArrayBuilder
                .custom();
        int issue = Integer.parseInt(LotteryIssuePrivate.getCurrentIssue(1).substring(8));//开始期数
        int tempIssue = issue;
    ...
    private static String getBettingData(String rebate) {
        JsonArrayBuilder jsonArrayBuilder = JsonArrayBuilder
                .custom();
        String[] betContentArray0 = "A10`双`200.0000`1`1`1.00".split("@");
