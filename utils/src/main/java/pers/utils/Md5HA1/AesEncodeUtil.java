...
public class AesEncodeUtil {
    ...
    //偏移量
    public static final String VIPARA = "0123456789101112";   //AES 为16bytes. DES 为8bytes
    ...
    //私钥
    private static final String AES_KEY = "d,a.f@a%g&a(m)e?";   //AES固定格式为128/192/256 bits.即：16/24/32bytes。DES固定格式为128bits，即8bytes。
    ...
    public static String decrypt(String encrypted) {
        try {
            ...
            cipher.init(Cipher.DECRYPT_MODE, key, zeroIv); //CBC
    ...
    public static void main(String[] args) throws Exception {
        String content = "";
